...
#
# reads over a socket in a shared volume the log output
# from the main container, enriches it and writes it to
# stdout as single line JSON. Next step is to add a
# fluentd client or a similar tool for central
# aggregation of logs.
#
